...
const CONTACT_INFO = [
  ...
  { icon: Mail, text: "help@pashora.com", href: "mailto:help@pashora.com", label: "Email us" },
...
const SOCIAL_LINKS = [
  {
    label: "Facebook",
    href: "https://facebook.com/pashora",
  ...
  {
    label: "Twitter",
    href: "https://twitter.com/pashora",
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/pashora",
    color: "hover:bg-primary-dark hover:text-white",
  ...
  return (
    <li>
      <Link
        to={href}
        onClick={handleClick}
        className="text-gray-400 text-sm hover:text-primary transition-colors inline-flex items-center gap-1 group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded px-1 -mx-1"
      >
...
const ContactItem = ({ icon: Icon, text, href, label }) => (
  <li>
    <a
      href={href}
      className="flex items-start gap-3 text-gray-400 text-sm hover:text-primary transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded-lg p-1 -mx-1"
      aria-label={label}
    >
      <Icon className="h-4 w-4 flex-shrink-0 mt-0.5 text-primary group-hover:scale-110 transition-transform" />
      <span className="leading-snug group-hover:text-primary transition-colors">{text}</span>
    </a>
  </li>
);
...
const ScrollToTop = () => {
  ...
  return (
    <button
      onClick={scroll}
      className="fixed bottom-6 right-6 z-40 h-10 w-10 bg-gradient-to-r from-primary to-primary-light text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 active:scale-95 transition-all flex items-center justify-center"
  ...
  return (
    <>
      <footer className="bg-slate-900 text-white w-full">
        {/* Gradient top border */}
        <div className="h-1 w-full bg-gradient-to-r from-primary via-primary to-primary-light" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              <div className="flex items-center gap-2 mb-4">
                <Heart className="h-5 w-5 text-primary fill-primary flex-shrink-0" aria-hidden="true" />
        ...
        <div className="border-t border-slate-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-center">
            ...
            <p className="text-gray-500 text-xs sm:text-sm flex items-center gap-1">
              Made with
              <Heart className="h-3 w-3 text-primary fill-primary inline" aria-hidden="true" />
              by Rezen boi
            </p>
          </div>
        </div>
