...
const LoginForm = () => {
  ...
  const handleBlur = (e) => {
    const { name, value } = e.target;
    const actualValue = name === 'email' ? formData.addressEmbeddable.email : value;
  ...
  const validateAllFields = () => {
    ...
    fieldsToValidate.forEach(field => {
      const value = field === 'email' ? formData.addressEmbeddable.email : formData[field];
  ...
  useEffect(() => {
    ...
    const hasAllRequiredFields = formData.addressEmbeddable.email && formData.password;
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Redirect or store user in localStorage/sessionStorage here
      }
      */
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`appearance-none block w-full pl-10 pr-10 py-3 border ${
                    ...
                    touched.email && !errors.email ? 'border-green-300 focus:border-green-500 focus:ring-green-500' :
                ...
                />
                {touched.email && !errors.email && formData.addressEmbeddable.email && (
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`appearance-none block w-full pl-10 pr-10 py-3 border ${
                    ...
                    touched.password && !errors.password ? 'border-green-300 focus:border-green-500 focus:ring-green-500' :
                    'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500'
                  } rounded-lg placeholder-gray-400 focus:outline-none focus:ring-1 sm:text-sm transition-colors duration-200`}
