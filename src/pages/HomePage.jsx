...
const CategoryCard = ({ category, index }) => {
  ...
  return (
    <Link
      ...
      className={`group bg-gradient-to-br ${gradient} rounded-2xl p-4 sm:p-6 text-center hover:shadow-md active:scale-95 transition-all cursor-pointer border border-white/60 w-[calc(50%-8px)] sm:w-[calc(33.33%-14px)] lg:w-[calc(25%-18px)] xl:w-[calc(20%-20px)]`}
    >
