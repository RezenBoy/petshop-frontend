    ...
    <div className="min-h-screen bg-background text-text">
      ...
      <section className="py-16 sm:py-20 bg-surface border-b border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-text mb-4 leading-tight">
            About{" "}
            <span className="bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
              {BRAND.name}
            </span>
          </h1>
          <p className="text-textMuted text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1">
              <img
                ...
                className="rounded-2xl w-full object-cover shadow-sm border border-border"
              />
            </div>
            ...
            <div className="flex-1 text-left">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-text mt-2 mb-4 leading-tight">
              ...
              <p className="text-textMuted text-sm sm:text-base leading-relaxed mb-8">
              ...
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 text-sm font-semibold text-surface bg-primary hover:bg-primary/90 px-6 py-2.5 rounded-full active:scale-95 transition-all shadow-sm"
              >
                Shop Now
      ...
      {/* ── What Drives Us ── */}
      <section className="py-16 sm:py-20 bg-surface/60 border-y border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                color: "text-primary bg-secondary/30",
              },
              {
                icon: Heart,
                title: "Our Vision",
              ...
              <div
                key={title}
                className="flex flex-col items-center text-center p-5 sm:p-6 rounded-2xl bg-surface border border-border hover:border-accent/40 hover:shadow-sm transition-all"
              >
                <div className={`h-11 w-11 rounded-xl flex items-center justify-center mb-3 ${color}`}>
                  <Icon className="h-5 w-5" />
                </div>
                <h3 className="font-semibold text-text text-sm sm:text-base mb-1.5">{title}</h3>
                <p className="text-textMuted text-xs sm:text-sm leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {[
              ...
              <div
                key={title}
                className="flex flex-col items-center text-center p-4 rounded-2xl bg-surface border border-border hover:border-primary/40 hover:shadow-sm transition-all"
              >
      ...
      {/* ── Stats ── */}
      <section className="py-16 sm:py-20 bg-surface/60 border-t border-border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-14">
            <span className="text-xs font-semibold tracking-widest text-accent uppercase">
              By The Numbers
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div
                key={label}
                className="border border-border hover:border-primary/40 rounded-2xl p-5 sm:p-6 flex flex-col gap-1 transition-all hover:shadow-sm bg-surface"
              >
